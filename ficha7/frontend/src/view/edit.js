...
class EditComponent extends React.Component {
    ...
    sendUpdate() {
        // get parameter id
        let userId = this.props.match.params.filmesId;
        // url de backend
        const url = baseUrl + "/filmes/update/" + userId
    ...
    componentDidMount() {
        let userId = this.props.match.params.filmesId;
        const url = baseUrl + "/filmes/get/" + userId
        axios.get(url)
            .then(res => {
                if (res.data.success) {
            ...
            <div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputState" class="form-control"
                            ...
                            <option selected
                                value={this.state.dataEmployee.roleId}>{this.state.stringRole}</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" placeholder="Phone"
                            value={this.state.campPhone} onChange={(value) =>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputAddress"
                        ...
                        value={this.state.campAddress} onChange={(value) =>
